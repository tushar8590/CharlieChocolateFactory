...
public class TestDataUpdater implements VendorDataUpdater, Runnable {
    ...
    public boolean processData() {
        ...
        if (vendor.equalsIgnoreCase("infibeam")) {
            ...
            for (String url : urls) {
                try {
                    ...
                    try {
                        String starRating = driver.findElement(By.cssSelector("#review_and_rating_summary > span.rating-star > img:nth-child(1)")).getAttribute("alt")
                            .toString();
                        product.setProductRating(starRating);
                        System.out.println(starRating);
                    }
        ...
        if (vendor.equalsIgnoreCase("snapdeal")) {
            ...
            for (String url : urls) {
                try {
                    ...
                    String title = driver
                        .findElement(
                            By.cssSelector("#pdp > div:nth-child(3) > div.pdpCatWrapper.pdpPage.blk.pdp3Revamp > div.productDeal-right > div.prodtitle-head > div.productTitle > div > h1"))
                        .getText();
                    product.setProductModel(title);
                    System.out.println(title);
                    ...
                    try {
                        String starRating = driver
                            .findElement(
                                By.cssSelector("#pdp > div:nth-child(3) > div.pdpCatWrapper.pdpPage.blk.pdp3Revamp > div.productDeal-right > div.prodtitle-head > div.productTitle > div > div.lfloat > div.lfloat.pdpRatingStars"))
                            .getAttribute("ratings").toString();
                        product.setProductRating(starRating);
                        System.out.println(starRating);
        ...
        if (vendor.equalsIgnoreCase("indiatimes")) {
            ...
            for (String url : urls) {
                try {
                    ...
                    String title = driver
                        .findElement(
                            By.cssSelector("#contentbody > div.content-wrap > div.productdetailwrapper > div.productcontainer.pdpboxline.clear > div.flt.productcolumone.zur > h1"))
                        .getText().toString();
                    product.setProductModel(title);
                    System.out.println(title);
                    ...
                    try {
                        String starRating = driver
                            .findElement(
                                By.cssSelector("#contentbody > div.content-wrap > div.productdetailwrapper > div.productcontainer.pdpboxline.clear > div.flt.productcolumone.zur > div > span > span.rating.flt > span > span"))
                            .getText().toString();
                        product.setProductRating(starRating);
                        System.out.println(starRating);
                    }
        ...
        if (vendor.equalsIgnoreCase("shopclues")) {
            ...
            for (String url : urls) {
                try {
                    ...
                    String title = driver
                        .findElement(
                            By.cssSelector("#content > div.content-helper > div.aside-site-content.left > div.site-content > div.product > form > div.product-about > div.name > h1"))
                        .getText().toString();
                    product.setProductModel(title);
                    System.out.println(title);
                    ...
                    String prodId = driver
                        .findElement(
                            By.cssSelector("#content > div.content-helper > div.aside-site-content.left > div.site-content > div.product > form > div.product-about > div.name > span > span"))
                        .getText();
        ...
        if (vendor.equalsIgnoreCase("rediff")) {
            ...
            for (String url : urls) {
                try {
                    ...
                    String title = driver.findElement(By.cssSelector("#div_prdetail_left > div > div.floatL.product_detail > div > div:nth-child(1) > h1 > span"))
                        .getText().toString();
                    product.setProductModel(title);
                    System.out.println(title);
         ...
         * String title = driver.findElement(By.cssSelector(
         * "#main > div.productdetail_container > div.productbucketgroup > div > div.productdetail_leftdiv > div.productdescription > div.rightpane > div.container9 > div.ctl_aboutbrand > h1"
         * )).getText();
         * product.setProductModel(title);
         * System.out.println(title);
         * 
        ...
        if (vendor.equalsIgnoreCase("Paytm")) {
            ...
            for (String url : urls) {
                try {
                    ...
                    // String title =
                    // driver.findElement(By.cssSelector("#midd-container-inner > div:nth-child(2) > div.product-details.left > div.product-title-wrapper > h2")).getText();
                    // product.setProductModel(title);
                    // System.out.println(title);
                    
                    String price = driver
                        .findElement(
                            By.cssSelector("#midd-container-inner > div:nth-child(2) > div.product-details.left > div.discraption > div.mt10 > div.left.mb10 > button:nth-child(1) > span.text"))
                        .getText();
                    product.setProductPrice(price);
                    System.out.println(price);
